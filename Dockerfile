...
RUN tar -xvzf phpmyadmin.tar.gz && mv phpMyAdmin-${PHPMYADMIN_VERSION}-all-languages/* . && rm -rf phpMyAdmin-${PHPMYADMIN_VERSION}-all-languages && rm -f phpmyadmin.tar.gz
